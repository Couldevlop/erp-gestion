...
describe('SousFamille e2e test', () => {
  ...
  it('should load SousFamilles', async () => {
    ...
    expect(await sousFamilleComponentsPage.getTitle()).to.eq('erpgestionApp.sousFamille.home.title');
    await browser.wait(
  ...
  it('should load create SousFamille page', async () => {
    ...
    expect(await sousFamilleUpdatePage.getPageTitle()).to.eq('erpgestionApp.sousFamille.home.createOrEditLabel');
  ...
  it('should create and save SousFamilles', async () => {
    ...
    await promise.all([
      sousFamilleUpdatePage.setIdSousFamilleInput('5'),
      sousFamilleUpdatePage.setNomSousFamilleInput('nomSousFamille'),
      sousFamilleUpdatePage.setDescriptionInput('description'),
      sousFamilleUpdatePage.setStateProvinceInput('stateProvince'),
  ...
  it('should delete last SousFamille', async () => {
    ...
    expect(await sousFamilleDeleteDialog.getDialogTitle()).to.eq('erpgestionApp.sousFamille.delete.question');
