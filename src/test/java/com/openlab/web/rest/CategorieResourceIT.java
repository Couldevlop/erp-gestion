...
class CategorieResourceIT {
    ...
    public static Categorie createEntity(EntityManager em) {
        Categorie categorie = new Categorie().idCategorie(DEFAULT_ID_CATEGORIE).nomCategorie(DEFAULT_NOM_CATEGORIE);
        return categorie;
    }
    ...
    public static Categorie createUpdatedEntity(EntityManager em) {
        Categorie categorie = new Categorie().idCategorie(UPDATED_ID_CATEGORIE).nomCategorie(UPDATED_NOM_CATEGORIE);
        return categorie;
    }
    ...
    void createCategorie() throws Exception {
        ...
        assertThat(testCategorie.getIdCategorie()).isEqualTo(DEFAULT_ID_CATEGORIE);
    ...
    void getAllCategories() throws Exception {
        ...
        restCategorieMockMvc
            ...
            .andExpect(jsonPath("$.[*].idCategorie").value(hasItem(DEFAULT_ID_CATEGORIE.intValue())))
    ...
    void getCategorie() throws Exception {
        ...
        restCategorieMockMvc
            ...
            .andExpect(jsonPath("$.idCategorie").value(DEFAULT_ID_CATEGORIE.intValue()))
    ...
    void putNewCategorie() throws Exception {
        ...
        updatedCategorie.idCategorie(UPDATED_ID_CATEGORIE).nomCategorie(UPDATED_NOM_CATEGORIE);
        ...
        Categorie testCategorie = categorieList.get(categorieList.size() - 1);
        assertThat(testCategorie.getIdCategorie()).isEqualTo(UPDATED_ID_CATEGORIE);
    ...
    void partialUpdateCategorieWithPatch() throws Exception {
        ...
        partialUpdatedCategorie.idCategorie(UPDATED_ID_CATEGORIE).nomCategorie(UPDATED_NOM_CATEGORIE);
